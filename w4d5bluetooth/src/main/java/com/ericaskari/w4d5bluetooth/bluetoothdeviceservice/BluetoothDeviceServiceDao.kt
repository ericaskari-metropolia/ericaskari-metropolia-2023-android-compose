...
//
    ...
    @Query("SELECT * from BluetoothDeviceService WHERE deviceAddress = :deviceAddress ORDER BY id DESC")
    fun getAllItemsByDeviceAddress(deviceAddress: String): Flow<List<BluetoothDeviceService>>
