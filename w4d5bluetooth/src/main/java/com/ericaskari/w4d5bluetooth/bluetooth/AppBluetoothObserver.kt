...
class AppBluetoothObserver(
    ...
    override fun onCreate(owner: LifecycleOwner) {
        ...
        // Initialization
        intentActivityResultLauncher = activityResultLauncherFactory(activity, owner, "AppBluetoothObserverLauncher")
    }
    ...
    companion object {
        ...
        private fun activityResultLauncherFactory(activity: ComponentActivity, owner: LifecycleOwner, key: String) =
